...
const HeroSection = () => {
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      <img
        src={heroImg}
        alt={`${hotelConfig.fullName} exterior at golden hour`}
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="font-heading text-xl md:text-2xl text-gold-light italic mb-2 animate-fade-in" style={{ animationDelay: "0.3s" }}>
          {hotelConfig.nameSuffix}, {hotelConfig.country}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: "0.5s" }}>
          <a
            href={hotelConfig.hero.primaryCta.href}
          ...
          >
            {hotelConfig.hero.primaryCta.label}
          </a>
          <a
            href={hotelConfig.hero.secondaryCta.href}
          ...
          >
            {hotelConfig.hero.secondaryCta.label}
          </a>
        </div>
      </div>
    </section>
