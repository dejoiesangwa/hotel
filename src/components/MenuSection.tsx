    ...
    <section id="menu" className="py-20 bg-background">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-12">
          <UtensilsCrossed className="w-9 h-9 text-gold mx-auto mb-3" />
          <p className="text-gold font-body text-sm tracking-[0.2em] uppercase mb-2">Restaurant</p>
          <h2 className="font-heading text-3xl md:text-5xl font-bold text-foreground">Food &amp; Drink Menu</h2>
        ...
        <div className="space-y-12">
          {specials.length > 0 && (
            <section>
              <div className="flex items-center gap-2 mb-5">
                ...
                <h3 className="font-heading text-2xl font-bold text-foreground">Today's Specials</h3>
              </div>
          ...
          {categories.map((cat) => {
            ...
            return (
              <section key={cat.id}>
                <h3 className="font-heading text-2xl font-bold text-foreground mb-1">{cat.name}</h3>
          ...
          {items.length === 0 && (
            <div className="text-center py-12 bg-card border border-border rounded-xl">
              ...
              <p className="font-body text-muted-foreground text-sm">Our menu will be available shortly.</p>
            </div>
          )}
        </div>
      </div>
